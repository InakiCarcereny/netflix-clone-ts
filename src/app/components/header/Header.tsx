      ...
      <div className="flex flex-col gap-44 max-w-[1524px] w-full h-full mx-auto">
        ...
        <div className="flex flex-col items-center gap-6 text-white z-50">
          ...
          <p className="text-white text-lg font-medium text-pretty max-w-[600px] text-center">
            Want to watch Netflix now? Enter your email address to create an
          ...
          <div className="flex items-center justify-center gap-2 max-w-[600px] w-full">
            <input
              placeholder="Email"
              type="text"
              className="text-white text-sm flex items-center justify-center rounded-[4px] border-zinc-200 border px-4 py-3.5 w-full placeholder:text-zinc-300 placeholder:text-xl placeholder:font-semibold"
            />
